...
final class LoginFlowCoordinator {
    ...
    func successLogin(_ userUID: String, _ identifier: String, _ secret: String) {
        LoginCacheManager.setNewLoginInfo(userUID: userUID, identifier: identifier, secret: secret)
