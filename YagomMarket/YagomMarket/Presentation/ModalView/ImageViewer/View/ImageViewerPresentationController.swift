...
final class ImageViewerPresentationController: UIPresentationController {
...
//        adoptPinchGestureRecognizer() //
    ...
    @objc private func dismissView(_ sender: UIPanGestureRecognizer) {
        ...
        if sender.state == .began {
            ...
            presentedView.center.y = originalPosition.y + translation.y * 0.4
            self.dimmingView.alpha = 1.0 - abs(translation.y/500)
